...
var _user$project$Model$QuerySucceed = function (a) {
	return {ctor: 'QuerySucceed', _0: a};
};
var _user$project$Model$SubmitQuery = {ctor: 'SubmitQuery'};
var _user$project$Model$UpdateQueryString = function (a) {
...
var _user$project$View$view = function (_p4) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('isthisbaokaka__main-wrapper'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('isthisbaokaka__heading-text'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('這是寶卡卡嗎？'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Update$decodePostQueryResponse = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'posts',
...
var _user$project$Update$submitQuery = function (queryString) {
	var processResult = function (result) {
		var _p0 = result;
		if (_p0.ctor === 'Ok') {
			return _user$project$Model$QuerySucceed(_p0._0);
		} else {
			return _user$project$Model$QueryFail(_p0._0);
		}
	};
	return A2(
		...
		A2(
			...
			_user$project$Update$postApi(queryString),
			_user$project$Update$decodePostQueryResponse));
};
